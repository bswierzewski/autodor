...
{
    public CreateContractorCommandValidator(ContractorsDbContext dbContext)
    {
        RuleFor(x => x.NIP)
            ...
            .MustAsync(async (nip, ct) => !await dbContext.Contractors.AnyAsync(c => c.NIP == new TaxId(nip), ct))
