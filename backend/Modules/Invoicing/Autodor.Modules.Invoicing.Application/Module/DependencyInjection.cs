...
/// <summary>
/// Provides dependency injection configuration for the Invoicing Application layer.
...
/// Ensures proper CQRS setup and service registration for the invoicing domain.
/// </summary>
public static class DependencyInjection
{
    /// <summary>
    /// Registers all application layer services for the Invoicing module into the dependency injection container.
    ...
    /// Essential for enabling the command/query processing pipeline in the invoicing domain.
    /// </summary>
