...
namespace Autodor.API.IntegrationTests.Modules.Orders.GetOrders;

[Collection(SharedCollection.Name)]
public class GetOrdersTests(DatabaseFixture databaseFixture, ITestOutputHelper output) : TestBase<Program>(databaseFixture)
{
