...
namespace Autodor.API.IntegrationTests.Modules.Orders.ExcludeOrderItem;

[Collection(SharedCollection.Name)]
public class ExcludeOrderItemTests(DatabaseFixture databaseFixture) : TestBase<Program>(databaseFixture)
{
    [Fact]
