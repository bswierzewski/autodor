...
namespace Autodor.API.IntegrationTests.Modules.Contractors.GetContractors;

[Collection(SharedCollection.Name)]
public class GetContractorsTests(DatabaseFixture databaseFixture) : TestBase<Program>(databaseFixture)
{
