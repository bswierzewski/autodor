...
namespace Autodor.Shared.Infrastructure.Persistence.Migrations;

/// <summary>
/// Handles applying pending Entity Framework Core database migrations for a given DbContext.
